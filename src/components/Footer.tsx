...
export default function Footer(): JSX.Element {
  return (
    <div className='flex w-full flex-col items-center justify-around bg-enactus-grey px-6 pb-8 text-white sm:px-16 md:flex-row md:px-12 lg:px-24'>
      <Link
        href='/'
        className='flex w-full cursor-pointer items-center justify-center py-6 md:mr-6 md:w-3/5 lg:mr-8 lg:w-2/6'>
      ...
      <div className='w-full py-4 md:ml-6 md:w-2/5 lg:ml-8 lg:w-2/6'>
        ...
        <div className='flex items-center justify-around px-8 py-6 sm:px-16 md:px-0'>
          <Link href='https://www.instagram.com/enactus_nsut/' target='_blank'>
